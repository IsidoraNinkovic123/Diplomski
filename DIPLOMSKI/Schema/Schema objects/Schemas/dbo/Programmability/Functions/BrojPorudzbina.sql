CREATE FUNCTION [dbo].[BrojPorudzbina](@datum date) RETURNS int
AS
BEGIN 
declare @brPorudzbina int;
set @brPorudzbina=0;

declare kon_cursor cursor for select Zaposleni.MBR from Zaposleni join Konobar on Zaposleni.MBR=Konobar.MBR;
